...
const Footer = () => {
  ...
  return (
    <footer className="mt-188px w-full bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="flex justify-between items-start">
          {/* Left side */}
          <div>
            <div className="text-gray-400 text-xs mb-4 pt-1 pb-1 pl-3 pr-3 bg-gray-700 max-w-[200px]">
              Free Open source AI template
            </div>
            <div className="text-gray-400 mb-4 text-2xl font-bold font-sans">
              Build your own Vintage Games GPT
            </div>
            <div className="flex items-center gap-4">
              <Link
                href="https://github.com/0xmetaschool/VintageGamesGPT/fork"
                className="bg-gray-800 text-gray-400 px-4 py-2 rounded-md hover:bg-gray-700 transition-colors text-xs"
              >
                Fork and Build Your Own
              </Link>
              <div className="relative inline-flex items-center group">
                <button className="flex text-gray-400 items-center gap-2 px-4 py-2 rounded-md border border-gray-400 hover:bg-white hover:text-black transition-colors text-xs">
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <div className="flex items-center gap-2 pt-8">
              ...
              <span className="text-gray-400 text-xl font-sans">♥</span>
              ...
              <div className="flex items-center">
                <Image
                  ...
                  height={20}
                />
                <span className="text-gray-400 text-xl font-semibold ml-2 leading-none font-sans">
                  metaschool
                </span>
              </div>
            </div>
